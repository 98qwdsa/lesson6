...
class Mathe extends React.Component {
  ...
  render() {
  return <><span>{/*请用class.contextType的方式获取EmailContext的值*/this.context}</span>
    <Calculator cb={this.props._editScore} />{/*请用props render的方式渲染附加分数组件最好使用children属性*/this.props.children}</>;
  }
}
